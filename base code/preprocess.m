...
all_data = [train0 ones(size(train0,1),1);
    train1 ones(size(train1,1),1);
    train2 ones(size(train2,1),1)*2;
    train3 ones(size(train3,1),1)*3;
    train4 ones(size(train4,1),1)*4;
    train5 ones(size(train5,1),1)*5;
    train6 ones(size(train6,1),1)*6;
    train7 ones(size(train7,1),1)*7;
    train8 ones(size(train8,1),1)*8;
    train9 ones(size(train9,1),1)*9];

% all_test_data = [test0 ones(size(test0,1),1) zeros(size(test0,1),9);
%     test1 zeros(size(test1,1),1) ones(size(test1,1),1) zeros(size(test1,1),8);
%     test2 zeros(size(test2,1),2) ones(size(test2,1),1) zeros(size(test2,1),7);
%     test3 zeros(size(test3,1),3) ones(size(test3,1),1) zeros(size(test3,1),6);
%     test4 zeros(size(test4,1),4) ones(size(test4,1),1) zeros(size(test4,1),5);
%     test5 zeros(size(test5,1),5) ones(size(test5,1),1) zeros(size(test5,1),4);
%     test6 zeros(size(test6,1),6) ones(size(test6,1),1) zeros(size(test6,1),3);
%     test7 zeros(size(test7,1),7) ones(size(test7,1),1) zeros(size(test7,1),2);
%     test8 zeros(size(test8,1),8) ones(size(test8,1),1) zeros(size(test8,1),1);
%     test9 zeros(size(test9,1),9) ones(size(test9,1),1)];


all_test_data = [test0 ones(size(test0,1),1);
    test1 ones(size(test1,1),1);
    test2 ones(size(test2,1),1)*2;
    test3 ones(size(test3,1),1)*3;
    test4 ones(size(test4,1),1)*4;
    test5 ones(size(test5,1),1)*5;
    test6 ones(size(test6,1),1)*6;
    test7 ones(size(test7,1),1)*7;
    test8 ones(size(test8,1),1)*8;
    test9 ones(size(test9,1),1)*9];

all_test_data(:) = all_test_data(randperm(size(all_test_data,1)),:);
